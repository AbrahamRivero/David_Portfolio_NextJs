...
export const works = [
	...
	},
	{
		...
		description: `This infographic shows the evolution of the fight between Márquez and Dovizioso. It shows us the data obtained by both riders throughout a whole MotoGP season.`,
		descriptionEsp: `Esta infografía muestra la evolución de la lucha entre Márquez y Dovizioso. Nos muestra los datos obtenidos por ambos motoristas a lo largo de toda una temporada de MotoGP.`,
		tag: 'Infographic',
		tagEsp: 'Infografía',
		tools: ['WordPress'],
	...
	},
	{
		...
		description: `This infographic shows the method of virus propagation. The idea for this image came about during the 2014 Ebola epidemic.`,
		descriptionEsp: `Esta infografía muestra el método de propagación de los virus. La idea de esta imagen surgió durante la epidemia de Ébola del año 2014.`,
		tag: 'Infographic',
		tagEsp: 'Infografía',
		tools: ['WordPress'],
	...
	},
	{
		...
		description: `This infographic tries to explain in a clear way what measles is, its symptoms and interesting facts about the disease. This idea was born after the outbreak of this disease in Italy and Israel in 2018.`,
		descriptionEsp: `Esta infografía trata de explicar de manera clara qué es el sarampión, sus síntomas y datos de interés relativos a la enfermedad. Esta idea nació tras el brote de esta enfermedad en Italia e Israel en el año 2018.`,
		tag: 'Infographic',
		tagEsp: 'Infografía',
		tools: ['WordPress'],
	...
	},
	{
		...
		description: `The first chart shows the basic composition of each of the major blood groups. Depending on the antigen and antibody it has (or not) it is classified in one way or another.
		...
		`,
		descriptionEsp: `La primera tabla muestra la composición básica de cada uno de los principales grupos sanguíneos. Dependiendo del antígeno y el anticuerpo que tiene (o no) se clasifica de una manera u otra.
	...
	},
	{
		...
		description: `This infographic, designed for National Geographic magazine, tells us about the main classification of stars. It provides information about each type of star along with a comparison of sizes and their temperatures.`,
		descriptionEsp: `Esta infografía, diseñada para la revista National Geographic, nos habla sobre la principal clasificación de las estrellas. Ofrece información sobre cada tipo de estrellas junto a una comparativa de tamaños y sus temperaturas.`,
		tag: 'Infographic',
		tagEsp: 'Infografía',
		tools: ['WordPress'],
	...
	},
	{
		...
		description: `This circle shows the score obtained by Valencia Basket in each of its games during the 2017 Euroleague basketball.`,
		descriptionEsp: `Este círculo muestra la puntuación obtenida por el Valencia Basket en cada uno de sus partidos durante la Euroliga de baloncesto de 2017.`,
		tag: 'Infographic',
		tagEsp: 'Infografía',
		tools: ['WordPress'],
	...
	},
	{
		...
		description: `Consists of posters for Social Networks (both post and stories) with the different signatures of authors who would go to the Murcia Book Fair with Editorial Sargantana and NPQ Editores.`,
		descriptionEsp: `Consiste en los carteles para Redes Sociales (tanto post como stories) con las diferentes firmas de autores que irían a la Feria del libro de Murcia con la Editorial Sargantana y NPQ Editores.`,
		tag: 'Graphic Design',
	...
	},
	{
		...
		description: `It consists of a small sample of posters for Social Networks (both post and stories) with the different signatures of authors who would go to the Valencia Book Fair with Editorial Sargantana, NPQ Editores and Editorial Brief.`,
		descriptionEsp: `Consiste en una pequeña muestra de los carteles para Redes Sociales (tanto post como stories) con las diferentes firmas de autores que irían a la Feria del libro de Valencia con la Editorial Sargantana, NPQ Editores y la Editorial Brief.`,
		tag: 'Graphic Design',
		tagEsp: 'Diseño Gráfico',
		tools: ['WordPress'],
		imagesUrls: [
	...
	},
	{
		...
		description: `These are the posters for Social Networks (both post and stories) for the 1st edition of the Valldigna book fair. It shows the different authors of Editorial Sargantana who went to sign at this fair.`,
		descriptionEsp: `Se trata de los carteles para Redes Sociales (tanto post como stories) para la 1ª edición de la feria del libro de la Valldigna. Muestra los diferentes autores de la Editorial Sargantana que fueron a firmar a esta Feria.`,
		tag: 'Graphic Design',
		tagEsp: 'Diseño Gráfico',
		tools: ['WordPress'],
		imagesUrls: [
	...
	},
	{
		...
		description: `One of the projects I did for Grupo Editorial Sargantana. It is a catalog that explains different activities aimed at different grades of the school stage. It explains what the activity consists of and provides information such as the materials needed and the price.`,
		descriptionEsp: `Uno de los proyectos que realicé para el Grupo Editorial Sargantana. Se trata de un catálogo en el que se explican diferentes actividades orientadas a distintos cursos de la etapa escolar. Se explica en qué consiste la actividad y se ofrecen datos como los materiales necesarios y el precio.`,
	...
	},
	{
		...
		description: `This was another of the projects I did for Grupo Editorial Sargantana. It is a catalog to sell books to schools. It shows the different titles of the publishing house that may be of interest to a school, classified by age.`,
		descriptionEsp: `Este proyecto fue otro de los que realicé para el Grupo Editorial Sargantana. Se trata de un catálogo para vender libros a colegios. Se muestran los diferentes títulos de la editorial que pueden interesar a un colegio, clasificados por edades.`,
		tag: 'Editorial Design',
		tagEsp: 'Diseño Editorial',
		tools: ['WordPress'],
		imagesUrls: [
	...
	},
	{
		...
		description: `One of the projects I did for Grupo Editorial Sargantana. It is a catalog that shows the comics published by the publisher. First the novelties are shown and then the products in stock.`,
		descriptionEsp: `Uno de los proyectos que realicé para el Grupo Editorial Sargantana. Se trata de un catálogo en el que se muestran los cómics publicados por la editorial. Primero se muestran las novedades y luego los productos en stock.`,
		tag: 'Editorial Design',
		tagEsp: 'Diseño Editorial',
		tools: ['WordPress'],
		imagesUrls: [
	...
	},
	{
		...
		description: `This project is the general catalog for Grupo Editorial Sargantana. It includes the works of the 5 publishing houses that are included under the name of the group. It is designed in a modular way to be able to extract the catalog of each of the publishers and print it separately.`,
		descriptionEsp: `Este proyecto es el catálogo general para el Grupo Editorial Sargantana. En él se incluyen las obras de las 5 editoriales que se engloban bajo el nombre del grupo. Está diseñado de forma modular para poder extraer el catálogo de cada una de las editoriales e imprimirlo por separado.`,
		tag: 'Editorial Design',
		tagEsp: 'Diseño Editorial',
		tools: ['WordPress'],
		imagesUrls: [
	...
	},
	{
		...
		description: `Publication created for my Final Degree Project (FDP). It consists of a supplement for the Levante-EMV newspaper of scientific and health journalism. The publication model was based entirely on the style of Levante-EMV.
		...
		`,
		descriptionEsp: `Publicación creada para mi Trabajo de Fin de Grado (TFG). Consiste en un suplemento para el periódico Levante-EMV de periodismo científico y sanitario. El modelo de publicación se basó enteramente en el estilo del Levante-EMV.
...

	{
		...
		description: `Book designed during my time working for Editorial Sargantana. It consists of two main parts: the first is the digitalization of the book 50 años de historia del Rotary Club de Valencia and the second is the update of that book with the relevant events in the history of the club until 2021.`,
		descriptionEsp: `Libro diseñado durante mi etapa trabajando para la Editorial Sargantana. Se compone de dos partes principales: la primera es la digitalización del libro 50 años del Rotary Club de Valencia y la segunda es la actualización de ese libro con los acontecimientos relevantes en la historia del club hasta llegar al año 2021.`,
		tag: 'Editorial Design',
		tagEsp: 'Diseño Editorial',
		tools: ['WordPress'],
		imagesUrls: [
	...
	},
	{
		...
		description: `Book designed during my time working for Editorial Sargantana. It consists of a compilation of stories written by primary school students from different schools in Alberic.`,
		descriptionEsp: `Libro diseñado durante mi etapa trabajando para la Editorial Sargantana. Consiste en una recopilación de historias escritas por alumnos de primaria de diferentes colegios de Alberic.`,
		tag: 'Editorial Design',
		tagEsp: 'Diseño Editorial',
		tools: ['WordPress'],
	...
	},
	{
		...
		description: `Book designed during my time working for Editorial Sargantana. This novel tells the story of a high school teacher who enlists in the Navy and ends up in poverty while traveling through France.`,
		descriptionEsp: `Libro diseñado durante mi etapa trabajando para la Editorial Sargantana. Esta novela nos relata la historia de un profesor de liceo que se alista en la Marina y acaba en la pobreza mientras recorre Francia.`,
		tag: 'Editorial Design',
		tagEsp: 'Diseño Editorial',
		tools: ['WordPress'],
		imagesUrls: [
	...
	},
	{
		...
		description: `Book designed during my time working for Editorial Sargantana. It brings together different events that have taken place over several centuries of the history of the town of Ayora.`,
		descriptionEsp: `Libro diseñado durante mi etapa trabajando para la Editorial Sargantana. Agrupa diferentes sucesos acontecidos durante varios siglos de historia de la Villa de Ayora.`,
		tag: 'Editorial Design',
		tagEsp: 'Diseño Editorial',
		tools: ['WordPress'],
	...
	},
	{
		...
		description: `The first book I designed during my time working for Editorial Sargantana. It consists of a collection of watercolors, designed by Antonio Ponce, which portray the city of Cuenca.`,
		descriptionEsp: `El primer libro que diseñé durante mi etapa trabajando para la Editorial Sargantana. Consiste en una recopilación de acuarelas, diseñadas por Antonio Ponce, que retratan la ciudad de Cuenca.`,
		tag: 'Editorial Design',
		tagEsp: 'Diseño Editorial',
		tools: ['WordPress'],
	...
	},
	{
		...
		description: `Book designed during my time working for Editorial Sargantana. Fantasy story written in which narrates the adventures of two gods, Día y Noche, and their fight against powerful enemies to save their world.`,
		descriptionEsp: `Libro diseñado durante mi etapa trabajando para la Editorial Sargantana. Historia de fantasía escrita en la que narra las aventuras de dos dioses, Día y Noche, y su lucha contra poderosos enemigos para salvar su mundo.`,
		tag: 'Editorial Design',
		tagEsp: 'Diseño Editorial',
		tools: ['WordPress'],
	...
	},
	{
		...
		description: `Book designed during my time working for Editorial Sargantana. It tells the story of a girl who exchanges correspondence with a writer and shows us how their relationship evolves without meeting in person.`,
		descriptionEsp: `Libro diseñado durante mi etapa trabajando para la Editorial Sargantana. Cuenta la historia de una chica que intercambia correspondencia con un escritor y nos enseña cómo va evolucionando su relación sin conocerse en persona.`,
		tag: 'Editorial Design',
		tagEsp: 'Diseño Editorial',
		tools: ['WordPress'],
	...
	},
	{
		...
		description: `Book designed during my time working for Editorial Sargantana. It tells the story of an art appraiser who gets involved in the investigation of the murder of a friend of hers.`,
		descriptionEsp: `Libro diseñado durante mi etapa trabajando para la Editorial Sargantana. Cuenta la historia de una tasadora de arte que se ve envuelta en la investigación del asesinato de un amigo suyo.`,
		tag: 'Editorial Design',
		tagEsp: 'Diseño Editorial',
		tools: ['WordPress'],
	...
	},
	{
		...
		description: `Book designed during my time working for Editorial Sargantana. First part of a trilogy that places us in Madrid while we accompany the protagonist during the investigation of an attack.`,
		descriptionEsp: `Libro diseñado durante mi etapa trabajando para la Editorial Sargantana. Primera parte de una trilogía que nos sitúa en Madrid mientras acompañamos al protagonista durante la investigación de un atentado.`,
		tag: 'Editorial Design',
		tagEsp: 'Diseño Editorial',
		tools: ['WordPress'],
